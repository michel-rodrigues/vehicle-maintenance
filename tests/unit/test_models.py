...
def test_should_register_new_services_per_item(registred_vehicle):
    ...
    registred_vehicle.maintenance_performed([last_service_item_performed])
...
def test_should_accumulate_service_items(registred_vehicle):
